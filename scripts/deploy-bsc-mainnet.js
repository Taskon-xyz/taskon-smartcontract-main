...
//npx hardhat run ./scripts/deploy-bsc-mainnet.js --network bsc_mainnet
async function main() {
    ...
    const managerProxy = await ethers.getContractAt("ManagerProxy", "0x7cF3d2fE1bB390566C0f8b491eC04837aeB87536");
